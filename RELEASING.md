...
```bash
curl -L https://github.com/arch1904/MacMp4ScreenRec/archive/refs/tags/v1.1.0.tar.gz | shasum -a 256
```
...
script/update-release-formula.sh 1.1.0 <sha256-from-step-3>
```
...
git commit -m "Release mac-mp4-screen-rec v1.1.0"
git push origin main
```
